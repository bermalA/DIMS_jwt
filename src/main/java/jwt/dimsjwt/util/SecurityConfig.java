...
public class SecurityConfig {
    private final UserDetailsServiceDAO userDetailsServiceDAO;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests(auth -> auth
                        .requestMatchers("/", "/login", "/register").permitAll()  // Ensure /register is permitted
                        .requestMatchers("/user/resource").hasAnyRole("USER", "ADMIN")
